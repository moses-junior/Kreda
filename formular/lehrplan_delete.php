...
if($_GET["bestaetigen"]=="ja") {
   $deleter=del_array2echo(delete_db_object("lehrplan", array(injaway($_GET["id"])), $pfad, false), "sql");
    ...
    echo '<body><div class="inhalt"><form action="'.$pfad.'formular/lehrplan_delete.php?bestaetigen=ja&amp;id='.$_GET["id"].'" method="post">
        <p>Der Lehrplan wird endg&uuml;ltig (zusammen mit allen ihm zugeordneten Daten) gel&ouml;scht.</p>';
    echo del_array2echo(delete_db_object("lehrplan", array(injaway($_GET["id"])), $pfad, false), "info");
