...
db_conn_and_sql("UPDATE fach_klasse SET bewertungstabelle=".leer_NULL($_POST["bewertungstabelle"]).", notenberechnungsvorlage=".leer_NULL($_POST["vorlage"])." WHERE id=".$_POST["fach_klasse"]);
