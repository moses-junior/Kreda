...
$pfad="../";
$titelleiste="Inhalt hinzuf&uuml;gen";
...
<body> 
	...
	<div class="inhalt">
	<form action="<?php echo $pfad; ?>formular/abschnitt_neu.php?abschnitt=<?php echo $_GET["abschnitt"]; ?>&amp;eintragen=true" method="post" enctype="multipart/form-data" accept-charset="ISO-8859-1">
		<?php echo eintragung_inhaltstypen(0); ?>
