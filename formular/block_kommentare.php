...
if (proofuser("block", $_GET["block"]))
	db_conn_and_sql("UPDATE `block` SET `kommentare`=".apostroph_bei_bedarf($_POST["kommentare"]).", `methodisch`=".apostroph_bei_bedarf($_POST["methodisch"])." WHERE `id`=".injaway($_GET["block"]));
