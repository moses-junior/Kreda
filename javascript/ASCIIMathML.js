// ca. in Zeile 280 sind ein paar eigene Symbole definiert
...
var notifyIfNoMathML = false;   // display note at top if no MathML capability: standard: true
...
// eigene
{input:"|!", tag:"mo", output:"\u2224", tex:"teiltnicht", ttype:CONST},
{input:"||", tag:"mo", output:"\u2225", tex:"parallel", ttype:CONST},
{input:"!||", tag:"mo", output:"\u2226", tex:"notparallel", ttype:CONST},
{input:"!-=",  tag:"mo", output:"\u2262", tex:"notidenticalto", ttype:CONST},
{input:"^=",  tag:"mo", output:"\u2259", tex:"entspricht", ttype:CONST},
{input:"!!!",  tag:"mtext", output:"\u21AF", tex:"zigzagarrow", ttype:CONST},
{input:"/_",  tag:"mo", output:"\u2221",  tex:"angle", ttype:CONST}, // ersetzt
{input:"[]",  tag:"mtext", output:"\u2B1C", tex:"big_square", ttype:CONST},
...
function LMprocessNode(n) {
  ...
  var am = /amath\b|graphsollkeinschluesselwortsein/i.test(st);
